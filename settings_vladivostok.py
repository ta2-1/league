...
DATABASES = {
    'default': {
        ...
        'NAME': 'squash_vladivostok',                      	# Or path to database file if using sqlite3.
...
SECRET_KEY = 'v2_tnrvcw669t&y21q6uo_ka_p1s(ekw-d!6!h+ujd%!zr5xc*'
