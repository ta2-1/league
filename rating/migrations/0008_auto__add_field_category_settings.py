...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.settings'
        db.add_column('rating_category', 'settings',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rating.CategorySettings']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.settings'
        db.delete_column('rating_category', 'settings_id')
    ...
    models = {
        'rating.category': {
            ...
            'settings': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rating.CategorySettings']"}),
