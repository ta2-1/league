...
site.addsitedir('/home/taras/projects/squash/env/squash/lib/python2.6/site-packages')
...
sys.path.append('/home/taras/projects/squash/src/trunk/squash')

# Now do DJANGO_SETTINGS_MODULE and create the WSGI app.
os.environ['DJANGO_SETTINGS_MODULE'] = 'settings_vladivostok'
