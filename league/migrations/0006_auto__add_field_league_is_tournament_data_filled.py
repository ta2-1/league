...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'League.is_tournament_data_filled'
        db.add_column('league_league', 'is_tournament_data_filled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'League.is_tournament_data_filled'
        db.delete_column('league_league', 'is_tournament_data_filled')
