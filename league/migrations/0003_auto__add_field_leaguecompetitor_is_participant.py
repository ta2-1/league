...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LeagueCompetitor.is_participant'
        db.add_column('league_leaguecompetitor', 'is_participant',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LeagueCompetitor.is_participant'
        db.delete_column('league_leaguecompetitor', 'is_participant')
