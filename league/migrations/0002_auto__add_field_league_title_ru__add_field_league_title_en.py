...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'League.title_ru'
        db.add_column('league_league', 'title_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'League.title_en'
        db.add_column('league_league', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'League.title_ru'
        db.delete_column('league_league', 'title_ru')

        # Deleting field 'League.title_en'
        db.delete_column('league_league', 'title_en')
