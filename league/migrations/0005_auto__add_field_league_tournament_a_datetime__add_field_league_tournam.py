...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'League.tournament_a_datetime'
        db.add_column('league_league', 'tournament_a_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default='2012-11-17'),
                      keep_default=False)

        # Adding field 'League.tournament_b_datetime'
        db.add_column('league_league', 'tournament_b_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default='2012-11-17'),
                      keep_default=False)

        # Adding field 'League.location'
        db.add_column('league_league', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rating.Location'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'League.tournament_a_datetime'
        db.delete_column('league_league', 'tournament_a_datetime')

        # Deleting field 'League.tournament_b_datetime'
        db.delete_column('league_league', 'tournament_b_datetime')

        # Deleting field 'League.location'
        db.delete_column('league_league', 'location_id')
    ...
    models = {
        'league.game': {
            ...
            'league': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['league.League']"}),
        ...
        'league.league': {
            ...
            'tournament_a_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'tournament_b_datetime': ('django.db.models.fields.DateTimeField', [], {})
        },
