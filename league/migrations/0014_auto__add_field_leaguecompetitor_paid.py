...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LeagueCompetitor.paid'
        db.add_column('league_leaguecompetitor', 'paid',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LeagueCompetitor.paid'
        db.delete_column('league_leaguecompetitor', 'paid')
