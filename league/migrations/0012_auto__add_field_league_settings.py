...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'League.settings'
        db.add_column('league_league', 'settings',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['league.LeagueSettings']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'League.settings'
        db.delete_column('league_league', 'settings_id')
    ...
    models = {
        ...
        'league.league': {
            ...
            'settings': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['league.LeagueSettings']"}),
