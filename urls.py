...
urlpatterns = patterns('',
    ...
    url(r'^competitors/(?P<competitor_id>\d+)/leagues/(?P<league_id>\d+)/gamerivals/$', 'league.views.competitor_game_rivals',{'template_name': 'league/competitor_game_rivals.html'}, name='competitor_game_rivals'),
    ...
    url(r'^leagues/$', 'league.views.leagues', name='leagues'),
